...
#include <gtksheet/gtkdataentry.h>
#include <gtksheet/gtkdatatextview.h>
#include <gtksheet/gtksheetfeatures.h>
...
struct _GtkSheet
{
    ...
    GType entry_type;  /* wanted entry type, default for all columns */
