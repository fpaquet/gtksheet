...
_gtksheet_signal_test( 
    GtkObject *object, guint signal_id, gint arg1, gint arg2,
...
extern void _gtksheet_signal_emit(GtkObject *object, guint signal_id, ...);
...
#endif
	_gtksheet_signal_emit(GTK_OBJECT(sheet),
	    sheet_signals[ENTER_PRESSED],
	    key,
	    &stop_emission);
#if GTK_SHEET_DEBUG_ENTER_PRESSED > 0
